...
import ShoeCard from "../Navbar/ShoeCard";
...
const Hero = () => {
  ...
  return (
    ...
    flex-col justify-center min-h-screen max-container "
    >
      <div
      ...
      >
        ...
        mb-14 sm:max-w-sm"
        >
          Discover Stylish Nike arrivals, quality comfort and innovation for ur
          active life
        </p>
        ...
        <div className="flex justify-start items-start flex-wrap w-full mt-20 gap-16">
          {statistics.map((stat) => (
            // here we are implementing the array of objects
            <div key={stat.label}>
      ...
      {/* xl:min-h-screen means lowest height on small devices (mobiles and tablets)  */}
      <div
        className="relative flex-1 flex justify-center items-center xl:min-h-screen 
      max-xl:py-40 bg-primmary bg-hero bg-cover bg-center "
      >
        <img
          src={bigShoeImg}
          alt="shoe collection"
